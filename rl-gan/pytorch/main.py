...
parser.add_argument('--zelda', action='store_true', help='run zelda experiment')
...
if opt.problem == 0:
    if opt.zelda:
        examplesJson = "exampleZelda.json"
    else:
        examplesJson = "exampleMario.json"
else:
...
for epoch in range(opt.niter):
    ...
    while i < num_batches:#len(dataloader):
        ...
        if (gen_iterations < 100 and gen_iterations % 10 == 0) or (gen_iterations < 500 and gen_iterations % 100 == 0) or (gen_iterations < 5000 and gen_iterations % 500 == 0) or (gen_iterations % 20000 == 0):   #was 500
            ...
            plt.imsave('{0}/zelda_fake_samples_{1}.png'.format(opt.experiment, gen_iterations), im)
