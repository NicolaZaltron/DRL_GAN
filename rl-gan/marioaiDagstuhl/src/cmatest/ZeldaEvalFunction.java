...
import communication.ZeldaProcess;
import fr.inria.optimization.cmaes.fitness.IObjectiveFunction;
import reader.JsonReader;

public class ZeldaEvalFunction implements IObjectiveFunction {
	...
	private ZeldaProcess zeldaProcess;
	...
	public ZeldaEvalFunction() throws IOException {
		// set up process for GAN
		ganProcess = new GANProcess();
		ganProcess.start();
		// set up zelda game
		zeldaProcess = new ZeldaProcess();
		zeldaProcess.start();        
        ...
        public ZeldaEvalFunction(String GANPath, String GANDim) throws IOException {
		// set up process for GAN
	...
	public double valueOf(double[] x) {
		try {
			...
			// Do a simulation
			EvaluationInfoZelda info = this.zeldaProcess.simulateOneLevel(level);
