...
//    public int totalNumberOfCoins = MagicNumberUndef;
    ...
    public int zeldaMode = MagicNumberUndef;
    ...
    public double computeBasicFitness()
    {
        ...
        return lengthOfLevelPassedPhys - timeSpentOnLevel + numberOfGainedCoins + zeldaStatus*5000;
    }
...
//                        totalNumberOfCoins,
    ...
    public String toString()
    {
        ...
        ret += "\n                       Zelda Status : " + ((zeldaStatus == Zelda.STATUS_WIN) ? "Win!" : "Loss...");
