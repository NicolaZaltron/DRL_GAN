...
public class Evaluator implements Runnable
{
    ...
    private List<EvaluationInfoMario> evaluationSummary = new ArrayList<EvaluationInfoMario>();
    ...
    private void evaluateServerMode()
    {
        ...
        while (server.isRunning())
        {
            ...
            if (resetData.startsWith("reset"))
            {
                ...
                // Simulate One Level
                EvaluationInfoMario evaluationInfo;
...
//                return evaluationSummary;
    ...
    public List<EvaluationInfoMario> evaluate()
    {
...
//    }
    ...
    public String exportToMatLabFile()
    {
        ...
        try {
            ...
            bw.newLine();
            bw.write("BasicFitness = [");
            for (EvaluationInfoMario ev : evaluationSummary)
    ...
    public void reset()
    {
        evaluationSummary = new ArrayList<EvaluationInfoMario>();
    }
...
class evBasicFitnessComparator implements Comparator
{
    ...
    {
        double ei1Fitness = ((EvaluationInfoMario)(o)).computeBasicFitness();
        double ei2Fitness = ((EvaluationInfoMario)(o1)).computeBasicFitness();
...
class evCoinsFitnessComparator implements Comparator
{
    public int compare(Object o, Object o1)
    {
        int ei1Fitness = ((EvaluationInfoMario)(o)).numberOfGainedCoins;

        int ei2Fitness = ((EvaluationInfoMario)(o1)).numberOfGainedCoins;
        if (ei1Fitness < ei2Fitness)
            return 1;
        else if (ei1Fitness > ei2Fitness)
            return -1;
...
class evDistanceFitnessComparator implements Comparator
{
    public int compare(Object o, Object o1)
    {
        double ei1Fitness = ((EvaluationInfoMario)(o)).computeDistancePassed();
        double ei2Fitness = ((EvaluationInfoMario)(o1)).computeDistancePassed();
        if (ei1Fitness < ei2Fitness)
            return 1;
        else if (ei1Fitness > ei2Fitness)
            return -1;
