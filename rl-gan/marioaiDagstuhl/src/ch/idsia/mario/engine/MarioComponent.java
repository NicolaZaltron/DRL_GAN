...
//        }
    ...
    public EvaluationInfoMario run1(int currentTrial, int totalNumberOfTrials) {
        running = true;
        adjustFPS();
        EvaluationInfoMario evaluationInfo = new EvaluationInfoMario();
...
//            scene.keys = action;
            ...
            ((LevelScene) scene).mario.cheatKeys = cheatAgent.getAction(this);
