            ...
            if (yMarioD > -height && yMarioD < world.mario.height)
            {
                if (type != Enemy.ENEMY_SPIKY && world.mario.ya > 0 && yMarioD <= 0 && (!world.mario.onGround || !world.mario.wasOnGround))
                {
                    ...
                    else
                    {
                        ...
                        {
                            this.world.addSprite(new Shell(world, x, y, 0));
                        }
                        else if (type == Enemy.ENEMY_GREEN_KOOPA)
                        {
                            this.world.addSprite(new Shell(world, x, y, 1));
                        }
    ...
    public void move()
    {
        ...
        if (deadTime > 0)
        {
            ...
            if (deadTime == 0)
            {
                ...
                for (int i = 0; i < 8; i++)
                {
                    world.addSprite(new Sparkle(this.world, (int) (x + Math.random() * 16 - 8) + 4, (int) (y - Math.random() * 8) + 4, (float) (Math.random() * 2 - 1), (float) Math.random() * -1, 0, 1, 5));
                }
...
//                System.out.println("fireballCollideCheck");
                ++world.killedCreaturesTotal;
                ++world.killedCreaturesByFireBall;
                return true;
            }
        }
        return false;
