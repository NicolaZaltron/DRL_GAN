...
public class Art
{
    public static Image[][] zelda;
    public static Image[][] smallZelda;
    public static Image[][] fireZelda;
...
//            System.out.println(curDir);
        	/*
        	 * TODO:
        	 * WE NEED TO CHANGE THEESE SHEETS TO MARIO
        	 */
            zelda = cutImage(gc, "mariosheet.png", 32, 32);
            smallZelda = cutImage(gc, "smallmariosheet.png", 16, 16);
            fireZelda = cutImage(gc, "firemariosheet.png", 32, 32);
