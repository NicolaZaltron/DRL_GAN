...
public class GlobalOptions {
    ...
    public static boolean ZeldaAlwaysInCenter = false;
    ...
    private static ZeldaComponent zeldaComponent = null;
    private static GameViewerZelda gameViewer = null;
    ...
    public static boolean isZeldaInvulnerable;
    
       
    public static void registerZeldaComponent(ZeldaComponent mc)
    {
        zeldaComponent = mc;
    }

    public static ZeldaComponent getZeldaComponent() {
        return zeldaComponent;
    }
    

    public static void registerGameViewer(GameViewerZelda gv)
    {
        gameViewer = gv;
    }

    public static void AdjustZeldaComponentFPS() { zeldaComponent.adjustFPS(); }
