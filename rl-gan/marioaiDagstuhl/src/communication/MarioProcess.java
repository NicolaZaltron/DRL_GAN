...
public class MarioProcess extends Comm {
     ...
     * @return
     */
    public EvaluationInfoMario simulateOneLevel(Level level) {
        setLevel(level);
        EvaluationInfoMario info = this.simulator.simulateOneLevel();
        return info;
    }

    public EvaluationInfoMario simulateOneLevel() {
